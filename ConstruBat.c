...
int poserbat(int batselected,BITMAP* doublebuffer, t_ville* maVille,BITMAP* maison,BITMAP* cabane,BITMAP* immeuble,BITMAP* gratteciel,BITMAP* usine,BITMAP* chateaudeau,BITMAP* route)
{
    ...
    if(batselected==4)//usine
    {
        for(int i=0;i<NB_LIGNES;i++)
        {
            ...
            {
                if((mouse_y>234+i*20 && mouse_y<234+20+i*20)&&(mouse_x>740+j*20 && mouse_x<740+20+j*20) && i!=39  && i!=38 && i!=37 && i!=36 && i!=35 && i!=34 && j!=39 && j!=38 && j!=37 && j!=36 && j!=35  && maVille->map[i][j].habitation->type==0 && maVille->map[i+2][j].habitation->type==0 && maVille->map[i+1][j].habitation->type==0 && maVille->map[i+2][j+2].habitation->type==0 && maVille->map[i+1][j+1].habitation->type==0 && maVille->map[i][j+2].habitation->type==0 && maVille->map[i][j+1].habitation->type==0 && maVille->map[i+2][j+1].habitation->type==0 && maVille->map[i+1][j+2].habitation->type==0 && maVille->map[i+3][j].habitation->type==0 && maVille->map[i][j+4].habitation->type==0 && maVille->map[i][j+5].habitation->type==0 && maVille->map[i][j+3].habitation->type==0 && maVille->map[i+3][j+1].habitation->type==0 && maVille->map[i+3][j+2].habitation->type==0 && maVille->map[i+3][j+3].habitation->type==0 && maVille->map[i+3][j+4].habitation->type==0 && maVille->map[i+3][j+5].habitation->type==0 && maVille->map[i+2][j+4].habitation->type==0)
                {
    ...
    if(batselected==3)//chateau d'eau
    {
        for(int i=0;i<NB_LIGNES;i++)
        {
            for(int j=0;j<NB_COLONNES;j++)
            {
                if((mouse_y>234+i*20 && mouse_y<234+20+i*20)&&(mouse_x>740+j*20 && mouse_x<740+20+j*20) && i!=39 && j!=39 && i!=38 && i!=37 &&j!=38 && j!=37 && j!=36 && j!=35  && maVille->map[i][j].habitation->type==0 && maVille->map[i+2][j].habitation->type==0 && maVille->map[i+1][j].habitation->type==0 && maVille->map[i+2][j+2].habitation->type==0 && maVille->map[i+1][j+1].habitation->type==0 && maVille->map[i][j+2].habitation->type==0 && maVille->map[i][j+1].habitation->type==0 && maVille->map[i+2][j+1].habitation->type==0 && maVille->map[i+1][j+2].habitation->type==0 && maVille->map[i+3][j].habitation->type==0 && maVille->map[i+4][j].habitation->type==0 && maVille->map[i+5][j].habitation->type==0 && maVille->map[i][j+3].habitation->type==0 && maVille->map[i+1][j+3].habitation->type==0 && maVille->map[i+2][j+3].habitation->type==0 && maVille->map[i+3][j+3].habitation->type==0 && maVille->map[i+4][j+3].habitation->type==0 && maVille->map[i+5][j+3].habitation->type==0 && maVille->map[i+4][j+2].habitation->type==0)
                {
